 ...
 * @param mutation
 */
const bitbucketPreviewHack = async (mutation: MutationRecord): Promise<void> => {
 ...
 */
const mermaidPreviewerMutationCallback = async (mutations: MutationRecord[]): Promise<void> => {
...
export const watchDomMutation = async (): Promise<void> => {
  ...
  const wObserver = w.mermaidPreviewerMutationObserver as MutationObserver
  ...
  const mutationObserver = async (mutations: MutationRecord[]): Promise<void> => {
  ...
  w.mermaidPreviewerMutationObserver = observer
}
